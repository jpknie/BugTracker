...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="BugTrackerAzure" generation="1" functional="0" release="0" Id="6e867f43-5f4f-4a85-94ea-0d8dd18fd9fb" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
  ...
  <implements>
    <implementation Id="ecaacf11-846f-4d5c-8268-bdb058c9ebc4" ref="Microsoft.RedDog.Contract\ServiceContract\BugTrackerAzureContract@ServiceDefinition.build">
      <interfacereferences>
        <interfaceReference Id="e870752a-14ef-4d3a-a015-75a4fe7206c6" ref="Microsoft.RedDog.Contract\Interface\BugTracker:Endpoint1@ServiceDefinition.build">
          <inPort>
            <inPortMoniker name="/BugTrackerAzure/BugTrackerAzureGroup/BugTracker:Endpoint1" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="29df485b-b15d-4fd8-83ce-bea54ff7cdb6" ref="Microsoft.RedDog.Contract\Interface\BugTracker:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput@ServiceDefinition.build">
          <inPort>
            <inPortMoniker name="/BugTrackerAzure/BugTrackerAzureGroup/BugTracker:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput" />
          </inPort>
        </interfaceReference>
